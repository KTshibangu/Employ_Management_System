...
import { Calendar1Icon, ChevronRightIcon, DollarSignIcon, FileTextIcon, LayoutGridIcon, Loader2Icon, LogOutIcon, MenuIcon, SettingsIcon, UserIcon, XIcon } from 'lucide-react';
...
const Sidebar = () => {
        ...
        const fetchProfile = async () => {
            try {
                ...
                const fullName = data?.firstName
                    ...
                    : ""
                if (active) setUserName(fullName)
            } catch (e) {
        ...
        <>
            ...
            <div className='px-5 pt-6 pb-5 border-b border-white/6'>
                <div className="flex items-center justify-between">
                    ...
                    <button onClick={() => setMobileOpen(false)} className='lg:hidden text-slat-400 hover:text-white p-1'>
                        <XIcon size={20} />
                    </button>
                </div>
            </div>
            ...
            <div className='p-3 border-t border-white/6'>
                ...
                hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150 cursor-pointer'>
                    <LogOutIcon className='w-4.25 h-[1ppx]' />
                    <span>Log Out</span>
                </button>
            </div>
        </>
    ...
    return (
        <>
            ...
            {
                mobileOpen &&
                <div className='lg:hidden fixed insert-0 bg-black/60 backdrop-blur-sm z-40 '
            ...
            {/* Sidebar - mobile */}
            <aside className={`lg:hidden fixed insert-y-0 left-0 w-72 bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white
