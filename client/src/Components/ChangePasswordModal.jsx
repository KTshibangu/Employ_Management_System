            ...
            <div onClick={(e) => e.stopPropagation()}
                ...
                <div className='flex items-center justify-between p-6 pb-0'>
                    <h2 className='text-lg font-medium text-slate-900 flex items-center'>
                        <LockIcon className='w-5 h-5 text-slate-400 mr-2' />
                        Change Password
                    </h2>
                ...
                <form className='p-6 space-y-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <input type="password" name='newtPassword' required />
                    </div>
                    <div className='flex gap-3 pt-2'>
                        <button onClick={onClose} type='button' className='btn-secondary flex-1 cursor-pointer'>
                            Cancel
                        </button>
                        <button  type='submit' className='btn-primary flex-1 flex justify-center items-center gap-2 cursor-pointer' disabled={loading}>
