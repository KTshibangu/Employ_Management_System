                ...
                <div className='w-full max-w-md animate-fade-in'>
                    ...
                    <form className='space-y-5' onSubmit={handleSubmit}>
                        <div>
                            ...
                            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} required placeholder='test@example.com' />
                        </div>
                        <div>
                            <label className='block text-sm font-medium text-slate-700 mb-2'>Password</label>
                            <div className="relative">
                                <input className='pr-11' type={showPassword ? 'text' : 'password'} onChange={(e) => setPassword(e.target.value)} required placeholder='......' />
