            ...
            <div className='card p-5 sm:p-6'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 gap-5 text-sm text-slate-700'>
                    ...
                    <div>
                        ...
                        <input type='number' name='allowances' required min='0'
                            step='0.01' defaultValue={initialData?.allowances || 0} />
                    </div>
                    <div>
                        <label className='block mb-2'>Deductions</label>
                        <input type='number' name='deductions' required min='0'
                            step='0.01' defaultValue={initialData?.deductions || 0} />
                    </div>
                    {
                        isEditMode && (
                            <div>
